...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <div className="">
        <ul className=" border-nav w-full flex items-center justify-center">
        <form class="form">
      <button>
      ...
      <div className="flex items-center justify-center h-10 w-32 p-2 m-1 flex">
        ...
        <ul className="w-full dropdown-menu flex justify-center">
            ...
            <li className="flex flex-col items-center justify-center">
              <a>Pellet Eco-Fire</a>
              <img className="h-32 w-32 mt-2" src={pellet} alt="Brykiet Pellet Eco-Fire"/>
            </li>
            <li className="flex flex-col items-center justify-center">
              <a>Drewno Kominkowe</a>
              <img className="h-32 w-32 mt-2" src={bonfire} alt="Drewno Kominkowe"/>
            </li>
          </ul>
        ...
        <ul className="dropdown-menu flex justify-center">
            <li className="flex flex-col items-center justify-center">
              <a>Happy Cookies</a>
              <img className="h-32 w-32 mt-2" src={cookie} alt="Brykiet Eco-Coco"/>
            </li>
          </ul>
        <h3 className="m-1 flex item-center justify-center">↕</h3>
        </div>
        ...
        <ul className="dropdown-menu flex justify-center">
            <li className="flex flex-col items-center justify-center">
              <a>Euro palety</a>
              <img className="h-32 w-32 mt-2" src={pallet} alt="Brykiet Eco-Coco"/>
            </li>
          </ul>
        <h3 className="m-1 flex item-center justify-center">↕</h3>
        </div>
